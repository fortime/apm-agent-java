...
public class PlayFiltersInstrumentation extends AbstractPlayInstrumentation {
    private static final Logger logger = LoggerFactory.getLogger(PlayFiltersInstrumentation.class);
    ...
    public Junction<ClassLoader> getClassLoaderMatcher() {
        // todo check it
        return classLoaderCanLoadClass("play.http.DefaultHttpRequestHandler");
    }
